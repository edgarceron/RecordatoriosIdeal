	...
	<div class="panel-body">
		...
		$form=$this->beginWidget(
			...
			array(
				...
				'action'=>Yii::app()->createAbsoluteUrl('recordatorios/default/reporteLlamadas'),
		...
		<div class="col-lg-3">
			<div class="form-group">
				<?php echo CHtml::label('Recibida', 'recibida',array('class'=>'label label-success'));?>
				<?php echo 
					CHtml::dropDownList('recibida',
										$recibida,
										array('Si'=>'Si', 'No'=>'No'),
										array(
											'id'=>'recibida',
